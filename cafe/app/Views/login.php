...
<div class="position-relative">
 ...
 <form id="formAuthentication" class="mb-5" action="<?= base_url('home/aksi_login') ?>" method="post">
  ...
  <!-- Captcha: Dual Mode -->
  <div class="g-recaptcha mb-3" data-sitekey="6LeCA-8qAAAAACtGYDJketIE7D5rtGivxAF05ckN" id="gCaptcha"></div>

  <div class="mb-3" id="math-captcha" style="display: none;">
...
<p class="text-center mb-5">
  ...
  <a href="<?= base_url('home/registrasi') ?>" class="form-check mb-0">
...
<script>
  window.addEventListener('load', () => {
    ...
    if (isOnline) {
      // Tampilkan Google reCAPTCHA
      gCaptcha.style.display = 'block';
      mathCaptcha.style.display = 'none';
    } else {
      // Gak ada koneksi, pakai Math Captcha
